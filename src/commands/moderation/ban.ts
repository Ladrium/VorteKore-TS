...
import { VorteEmbed, VorteGuild, Command } from "../../lib";
...
export default class extends Command {
  ...
  public run(message: Message, [mem, ...reason]: any, guild: VorteGuild) {
    if (!checkPermissions(message.member!, "BAN_MEMBERS")) return message.channel.send(new VorteEmbed(message).errorEmbed("Missing Permissions!"));
